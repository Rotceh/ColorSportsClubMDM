...
import com.wj.clubmdm.weber.copyright.ColorSportsClub;
import com.wj.clubmdm.weber.util.ChkMotherBoardSN;
import com.wj.clubmdm.weber.util.DBConnectionFactory;
...
public class LoginController extends Application {
	...
	private boolean chkMotherBoardSN() {
		...
		if (cmbsn.getMotherBoardSN().equalsIgnoreCase(csc.getMotherBoardSN())) {
			return true;
		} else {
